...
public class GeneratorServiceImpl {
    ...
    public void generarCodigoServiceImpl(String nombreClase, String rutaPaquetes) {

        // Inicializar Velocity
        Velocity.init();
        log.info("generando servicio...");
        ...
        // Cargar la plantilla
        Template plantilla = Velocity.getTemplate("src/main/resources/templates/ServiceImpl.vm");

        // Procesar la plantilla y escribir el código en un archivo
        try {
            // Directorio de salida
            String directorioSalida = "src/main/java/com/manu/crud_generator/services/impl/";
            // Nombre del archivo
            String nombreArchivo = nombreClase + "ServiceImpl.java";
            ...
            log.info("Servicio generado exitosamente: " + directorioSalida + nombreArchivo);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
